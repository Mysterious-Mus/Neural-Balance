...
Hyperparameters are selected on a validation split using Gaussian-Process (GP) Bayesian optimization; the test set is used only for final numbers in Table~\ref{tab:regularization-mnist-fcn}. The protocol is:
\begin{itemize}
